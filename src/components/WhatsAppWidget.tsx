...
const WhatsAppWidget = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-24 right-4 lg:bottom-8 lg:right-8 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center"
